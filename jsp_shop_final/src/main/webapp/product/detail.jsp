								...
								<ul>
									<c:forEach items="${imgList }" var="iList">
										<li><img src="${img_url }${iList.pd_iname }" alt=""
											data-image="${img_url }${iList.pd_iname }" width="136px"
											height="136px"></li>
									</c:forEach>
								</ul>
							</div>
										...
										<c:choose>
											<c:when test="${qnaList ne null && qnaList ne ''}">
												...
												<c:forEach items="${qnaList }" var="qvo">
													<tr>
														<td><a href="./qctrl?sign=detail1&qno=${qvo.qno }">${qvo.qna_category }</a>
														</td>
														<td>${qvo.qna_date }</td>
				...
				<div id="tab_3" class="tab_container">
					<div class="row">
						...
						<div class="table-responsive">
							<div class="col additional_info_col">
								<div class="col-lg-6 add_review_col">
									<div class="add_review" style="margin-bottom: 30px;">
										<h4>Review</h4>
									</div>
								</div>
							</div>
							<c:choose>
									...
									<table class="table table-hover">
										<tbody>
											<c:forEach items="${revList }" var="rvo">
												<tr>
													<td><h5>
															<strong>${rvo.rev_writer }</strong>
														</h5> <br>
														<p class="revdate">${rvo.rev_date }</p></td>
								...
								<c:otherwise>
									<div class="col additional_info_col">
										<div class="col-lg-6 add_review_col">
											<div class="add_review" style="margin-top: 30px;">
												<h3>리뷰가 없습니다</h3>
											</div>
										</div>
									</div>

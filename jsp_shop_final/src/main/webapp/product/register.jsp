...
<div>
	<div role="main" class="form-all">
		<form action="./ProductController?sign=regist" method="post"
			...
			<ul class="form-section page-section">
				...
				<li id="cid_3" class="form-input-wide" data-type="control_head">
					<div class="form-header-group  header-large">
						<div class="header-text httal htvam">
							<h1 id="header_3" class="form-header" data-component="header">상품등록</h1>
						</div>
					</div>
				</li>
				...
				<li class="form-line" data-type="control_textbox" id="id_6"><label
					...
					<div class="form-input" data-layout="half">
                     ...
                     <option value="Skin">Skin/Toner</option>
				...
				<li class="form-line" data-type="control_textarea" id="id_7"><label
					...
					<div id="cid_7" class="form-input" data-layout="full">
						<textarea id="content" class="form-textarea" name="content"
							...
							aria-labelledby="label_7"></textarea>
					</div></li>
				<!-- 상품정보 li 시작  -->
				<!-- 파일 li 시작 -->
				<li class="form-line" data-type="control_textbox" id="id_6"><label
					...
					<div id="cid_6" class="form-input" data-layout="half">
						<div class="filebox">
							...
							<label for="files1">파일선택</label> 
							<input type="file" id="files1" name="imgfile1" class="upload-hidden">
						</div>
						<div class="filebox">
							<input type="text" class="upload-name" disabled="disabled">
							<label for="files2">파일선택</label> 
							<input type="file" id="files2" name="imgfile2" class="upload-hidden">
						</div>
						<div class="filebox">
							<input type="text" class="upload-name" disabled="disabled">
							<label for="files3">파일선택</label> 
							<input type="file" id="files3" name="imgfile3" class="upload-hidden">
						</div>

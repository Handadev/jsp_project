...
<div class="main_slider"
	style="background-image: url(resource/images/HGenie_b1.png)">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="banner_item align-items-center"
					style="background-image: url(resource/images/banner_1.jpg)">
				</div>
			</div>
			<div class="col-md-4">
				<div class="banner_item align-items-center"
					style="background-image: url(resource/images/banner_2.jpg)">
				</div>
			</div>
			<div class="col-md-4">
				<div class="banner_item align-items-center"
					style="background-image: url(resource/images/banner_3.jpg)">
				</div>
			</div>
		</div>
	</div>
...
<div class="deal_ofthe_week" style="background-image: url(resource/images/HGenie_b2.png); background-size: cover;">
   <div class="container">
	...
	<div class="container">
		...
		<div class="row blogs_container">
			<div class="col-lg-4 blog_item_col">
				<div class="blog_item">
					<div class="blog_background"
						style="background-image: url(resource/images/blog_1.jpg)"></div>
					<div
			...
			<div class="col-lg-4 blog_item_col">
				<div class="blog_item">
					<div class="blog_background"
						style="background-image: url(resource/images/blog_2.jpg)"></div>
					<div
						class="blog_content d-flex flex-column align-items-center justify-content-center text-center">
						<h4 class="blog_title">Here are the trends I see coming this
							fall</h4>
			...
			<div class="col-lg-4 blog_item_col">
				<div class="blog_item">
					<div class="blog_background"
						style="background-image: url(resource/images/blog_3.jpg)"></div>
					<div
						class="blog_content d-flex flex-column align-items-center justify-content-center text-center">
						<h4 class="blog_title">Here are the trends I see coming this
							fall</h4>
